...
<h1>What is HTML?</h1>
	...
	<div class="post-content">
		...
		<div class="snippet" id="snippet-template-1">
			<div class="examples">
		...
		<div class="snippet" id="snippet-paragraph-1">
			<div class="how-it-looks">
				<h3>How it looks</h3>
				<div class="preview">
		...
		<div class="snippet" id="snippet-link-1">
			<div class="how-it-works">
				<h3>The code</h3>
...
<article class="post" id="what-is-css">
	...
	<h1>What is CSS?</h1>
		...
		<div class="snippet" id="snippet-paragraph-2">
			<div class="how-it-looks">
				<h3>How it looks</h3>
		...
		<div class="snippet" id="snippet-color-1">
			<div class="how-it-works">
				<h3>The code</h3>
